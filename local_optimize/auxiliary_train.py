...
if __name__ == '__main__':
    ...
    noise_set = np.load(r'D:\hyzhou\point cloud\denosie\branches\pci_15000_noise16.npy')

    smooth_set = np.load(r'D:\hyzhou\point cloud\denosie\branches\pci_15000_true16.npy')
    ...
    for epoch in range(epoches):
        ...
        plt_data(train_losses,'./loss_pic/res16train.png')
        plt_data(test_losses,'./loss_pic/res16test.png')
