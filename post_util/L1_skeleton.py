...
from post_util.post_utils import *
import time
...
def single_test():
    ...
    points = np.loadtxt(r'.\result\generate\10_2048.txt')
    ...
    myCenters = MyCenters(centers, h, maxPoints=1000)
    ...
    make_plot(points_s, compare_points=points)
    print("Performing median calculation: ", round(time2-time1, 2), "seconds")
